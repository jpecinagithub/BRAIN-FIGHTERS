...
export default function SimonGame() {
  const { player, publicCode } = useParams()
  ...
  return (
    <div className="simon-game-container">
      <motion.button 
        className="back-btn"
        onClick={() => navigate(`/play/${publicCode}`)}
      ...
      <div className="simon-ui-wrapper">
        <div className="simon-header-info">
          ...
          <motion.div 
            ...
            key={score}
            initial={{ scale: 1.1, color: '#7dffb0' }}
          ...
          >
            ...
            >
              ...
              <div className="modal-actions">
                ...
                <button className="btn-secondary" onClick={() => navigate(`/play/${publicCode}`)}>SALIR</button>
              </div>
            </motion.div>
          </motion.div>
        )}
